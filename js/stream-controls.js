...
// Script controls behavior of stream elements

$(document).ready(function () {

    $('.hs_topBar .hs_controls a').click(function (event) {
        var control = $(this);
        var dropdown = $('.hs_topBar .hs_dropdown');

        dropdown.children().hide();

        var item_name = control.attr('dropdown');

        if (item_name.length) {
            dropdown.children('.' + item_name).show();
        }
        ...
        if (dropdown.is(':visible') && control.hasClass('active')) {
            ...
            dropdown.show();
            if (item_name == '_search' || item_name == '_uploadActivity') {
                dropdown.find('.' + item_name + ' input[type="text"]').first().focus();
            } else if (item_name == '_uploadActivity') {
                dropdown.find('.' + item_name + ' input[type="text"]').first().focus();
            }
        }
